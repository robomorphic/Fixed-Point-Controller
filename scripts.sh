...
if [ "$1" == "panda_sweep" ]; then
    ...
    python3 scripts/whole_test.py --min-gravity-int 16 --max-gravity-int 16 --min-gravity-frac 16 --max-gravity-frac 16 --min-fd-int 6 --max-fd-int 16 --min-fd-frac 6 --max-fd-frac 16
elif [ "$1" == "panda" ]; then
